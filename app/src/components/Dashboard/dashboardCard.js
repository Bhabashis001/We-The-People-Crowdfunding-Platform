    ...
    return (
        <div className="col-lg-4 col-md-6 col-sm-12">
            <div className="card dash__card__body">
                <img src={props.el.LogoUrl || defaultLogo} className="card-img-top dash__card__image" alt="image" draggable={false} onError={(e)=>{e.target.onerror=null; e.target.src=defaultLogo}} />
