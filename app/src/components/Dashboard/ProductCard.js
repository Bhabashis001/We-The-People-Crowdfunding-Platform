            ...
            <div className="row">
                <div className="col-lg-4 col-md-12 col-sm-12 mb-3">
                    <div className="card card_icons">
                        <img src={props.data.LogoUrl || defaultLogo} alt="startup-logo" className="startup_logo_img" draggable={false} onError={(e)=>{e.target.onerror=null; e.target.src=defaultLogo}} />
                        {console.log("LogoUrl:", props.data.LogoUrl)}
